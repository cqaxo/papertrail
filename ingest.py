...
# Retrieve the top-k most relevant chunks, reranked by a cross-encoder
def retrieve(query, k=6, fetch_k=40):
...
# Cross-encoder used to rerank first-stage candidates
@lru_cache(maxsize=1)
def get_reranker():
